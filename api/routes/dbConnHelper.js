...
async function getAivenPgVersion(activeConfig) {
...
async function queryDailyStockStats(view) {
  ...
  stats.forEach(stat => {
    result.push({
      ...
      SCTR: stat.normalise_rs1,
      SCTR1: stat.normalise_rs1,
      SCTR2: stat.normalise_rs2,
      SCTR3: stat.normalise_rs3,
      SCTR4: stat.normalise_rs4,
      SCTR5: stat.normalise_rs5,
      SCTR6: stat.normalise_rs6,
      SCTR7: stat.normalise_rs7,
      SCTR8: stat.normalise_rs8,
      SCTR9: stat.normalise_rs9,
      SCTR10: stat.normalise_rs10,
      SCTR11: stat.normalise_rs11,
      SCTR12: stat.normalise_rs12,
      SCTR13: stat.normalise_rs13,
      SCTR14: stat.normalise_rs14,
      SCTR15: stat.normalise_rs15,
      SCTR16: stat.normalise_rs16,
      SCTR17: stat.normalise_rs17,
      SCTR18: stat.normalise_rs18,
      SCTR19: stat.normalise_rs19,
      SCTR20: stat.normalise_rs20,
      rs_priceoversma20: stat.rs_priceoversma20,
      rs_slopesma20: stat.rs_slopesma20,
      rs_slopesma50: stat.rs_slopesma50,
      rs_slopesma150: stat.rs_slopesma150,
      close: stat.close,
      delta: stat.delta,
